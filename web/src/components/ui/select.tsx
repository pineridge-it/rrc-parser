      ...
      <div className="relative">
        ...
        {isOpen && (
          ...
          >
            {/* Search input */}
            {searchable && (
              <div className="sticky top-0 bg-white dark:bg-[var(--color-surface-raised)] border-b border-[var(--color-border-default)] p-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search..."
                    className="w-full pl-9 pr-3 py-2 text-sm border border-[var(--color-border-default)] rounded-md focus:outline-none focus:border-[var(--color-brand-primary)]"
