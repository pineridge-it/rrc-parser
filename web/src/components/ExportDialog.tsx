    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto m-4">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Export Permits</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          {supportsGeometry(selectedFormat) && (
            <div className="flex items-center">
              ...
              />
              <label htmlFor="includeGeometry" className="ml-2 text-sm text-gray-700">
          ...
          <div>
            ...
            <div className="space-y-3 border border-gray-200 rounded-lg p-4">
              {categories.map((category) => {
                ...
                return (
                  <div key={category.key} className="border-b border-gray-100 last:border-0 pb-3 last:pb-0">
